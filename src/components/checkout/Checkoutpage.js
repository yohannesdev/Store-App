      ...
      <CheckOutHolder>
        ...
        <Infoholder>
          <div style={{ margin: "50px 0 0 40px" }}>
            ...
            {shipinginfo && (
              <Address>
                {shipinginfo.firstname}
                {shipinginfo.lastname} <br /> {shipinginfo.address} <br />{" "}
                {shipinginfo.city}
                {shipinginfo.state} {shipinginfo.zipcode}
              </Address>
            )}
            <AddInformation
              onClick={() => {
            ...
            {billinginfo && (
              <Address>
                ...
                {billinginfo.lastname} <br /> {billinginfo.address} <br />{" "}
                {billinginfo.city}
          ...
          <div style={{ margin: "70px 0 0 40px" }}>
            ...
            >
              <Order onClick={Emptycart}>Place Order</Order>
            </Link>
          </div>
